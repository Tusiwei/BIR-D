...
def main():
    ...
    def blur_cond_fn(x, t,weight=None,light_mask=None,guidance_scale=None, corner=None,y=None, x_lr=None, sample_noisy_x_lr=False, diffusion=None, sample_noisy_x_lr_t_thred=None):
    ...
    for i, data in enumerate(dataloader):
        if args.use_img_for_guidance:
            ...
            cond_fn = lambda x,t,weight,light_mask,guidance_scale,corner,y : blur_cond_fn(x, t,weight=weight,light_mask=light_mask,guidance_scale=guidance_scale, corner=corner, y=y, x_lr=image_lr, sample_noisy_x_lr=args.sample_noisy_x_lr, diffusion=diffusion, sample_noisy_x_lr_t_thred=args.sample_noisy_x_lr_t_thred)
        else:
            image, label = data
        ...
        weight = torch.tensor([[[[0.0022, 0.0040, 0.0059, 0.0073, 0.0078, 0.0073, 0.0059, 0.0039,
           0.0022],
          [0.0039, 0.0067, 0.0097, 0.0119, 0.0128, 0.0119, 0.0096, 0.0067,
           0.0039],
          [0.0058, 0.0096, 0.0136, 0.0168, 0.0179, 0.0168, 0.0136, 0.0096,
           0.0059],
          [0.0072, 0.0118, 0.0167, 0.0205, 0.0218, 0.0205, 0.0167, 0.0119,
           0.0073],
          [0.0077, 0.0127, 0.0179, 0.0218, 0.0234, 0.0218, 0.0179, 0.0127,
           0.0078],
          [0.0072, 0.0118, 0.0167, 0.0204, 0.0218, 0.0204, 0.0167, 0.0118,
           0.0073],
          [0.0057, 0.0095, 0.0135, 0.0167, 0.0179, 0.0167, 0.0136, 0.0096,
           0.0058],
          [0.0037, 0.0065, 0.0095, 0.0117, 0.0126, 0.0118, 0.0095, 0.0067,
           0.0039],
          [0.0020, 0.0037, 0.0057, 0.0071, 0.0076, 0.0072, 0.0057, 0.0038,
           0.0021]]]]
        )
        ...
        guidance_scale = torch.tensor(3000)
