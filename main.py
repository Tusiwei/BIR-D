...
def main():
    ...
    def blur_cond_fn(x, t,weight=None,light_mask=None,guidance_scale=None, y=None, x_lr=None, sample_noisy_x_lr=False, diffusion=None, sample_noisy_x_lr_t_thred=None):
        ...
        with th.enable_grad():
            ...
            if not x_lr is None:
                ...
                print('step t %d img guidance has been used, mse is %.8f' % (t[0], mse))
    ...
    for i, data in enumerate(dataloader):
        if args.use_img_for_guidance:
            ...
            cond_fn = lambda x,t,weight,light_mask,guidance_scale,y : blur_cond_fn(x, t,weight=weight,light_mask=light_mask,guidance_scale=guidance_scale, y=y, x_lr=image_lr, sample_noisy_x_lr=args.sample_noisy_x_lr, diffusion=diffusion, sample_noisy_x_lr_t_thred=args.sample_noisy_x_lr_t_thred)
        else:
            image, label = data
...
def create_argparser():
    ...
    parser.add_argument("--img_guidance_scale", default=2100, type=float, help='guidance scale')
